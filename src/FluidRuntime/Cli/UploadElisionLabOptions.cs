...
public sealed record UploadElisionLabOptions(
    string TargetPath,
    string HookPath,
    string OutputPath,
    int TrialPairs,
    ...
    bool UseHardware)
{
    public const int UploadBufferBytes = 4 * 1024 * 1024;
    public const int RedundantCopyCount = 64;

    public const string Usage =
        "Usage: fluidruntime upload-elision-lab --target <hook-target.exe> " +
    ...
    public static UploadElisionLabOptions Parse(string[] args)
    {
